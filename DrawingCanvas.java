...
public class DrawingCanvas extends JPanel {
    ...
    private void setupButtons() {
        ...
        freehandButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("free.png"))));
        freehandButton.addActionListener(e -> setCurrentShapeType(ShapeType.FREEHAND));

        JButton rectangleButton = new JButton();
        rectangleButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("rectangle.png"))));
        rectangleButton.addActionListener(e -> setCurrentShapeType(ShapeType.RECTANGLE));

        JButton circleButton = new JButton();
        circleButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("circle.png"))));
        circleButton.addActionListener(e -> setCurrentShapeType(ShapeType.CIRCLE));
        
        JButton FilledRectangleButton = new JButton();
        FilledRectangleButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("filled_rectangle.png"))));
        ...
        FilledCircleButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("filled_circle.png"))));
        FilledCircleButton.addActionListener(e -> setCurrentShapeType(ShapeType.FilledCircle));
        
        JButton LineButton = new JButton();
        LineButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("line.png"))));
        LineButton.addActionListener(e -> setCurrentShapeType(ShapeType.LINE));
        
        JButton colorButton = new JButton();
        colorButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("color.png"))));
        ...
        clearButton.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(DrawingCanvas.class.getResource("clear.png"))));
